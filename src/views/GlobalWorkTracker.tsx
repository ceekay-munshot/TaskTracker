...
export function GlobalWorkTracker() {
  ...
  const getSheets = (): ExcelSheet<unknown>[] => {
    const columns: ExportColumn<WorkItem>[] = [
      ...
      { header: 'Vipul Approval', value: (w) => w.vipulApprovalStatus },
      { header: 'Chiraag Review', value: (w) => w.chiraagReviewStatus },
      { header: 'Feedback Status', value: (w) => w.clientFeedbackStatus },
      { header: 'Improvement Count', value: (w) => w.improvementCount },
      {
