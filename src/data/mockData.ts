  ...
  },
  {
    ...
    pocs: [
      ...
      },
      {
        id: 'poc-aravali-2',
        name: 'Karthik Iyer',
        email: 'karthik.i@aravaliamc.in',
        phone: '+91 22 6655 4422',
        role: 'Tech Liaison',
      },
    ],
    ...
    pocs: [
      {
        id: 'poc-blackwood-1',
        name: 'Rishi Malhotra',
        email: 'rishi@blackwoodpe.com',
        phone: '+91 22 4488 1100',
        role: 'Principal',
      },
    ],
    ...
    pocs: [
      {
        ...
        email: 'lakshmi.n@sundarampension.in',
        phone: '+91 44 2233 6677',
        role: 'CIO',
      },
    ],
    ...
    pocs: [
      {
        id: 'poc-nordic-1',
        name: 'Erik Lundgren',
        email: 'erik.lundgren@nordicsov.no',
        phone: '+47 21 00 44 80',
        role: 'Managing Director',
      },
      {
        id: 'poc-nordic-2',
        name: 'Astrid Solberg',
        email: 'astrid.s@nordicsov.no',
        phone: '+47 21 00 44 92',
        role: 'Quant Lead',
      },
    ],
...
function buildWorkItem(spec: WiSpec): WorkItem {
  ...
  return {
    ...
    ownerIds: spec.ownerId ? [spec.ownerId] : [],
    ...
    claudeWorkStarted,
    liveOnMunshot,
    feedbackTaken: liveOnMunshot,
    improvementsInProgress: false,
    dashboardFinalized: liveOnMunshot,
    statusNote: '',
